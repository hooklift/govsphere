...
* In Github, fork `https://github.com/cloudescape/govsphere` to your own account
* Get the package using "go get": `go get github.com/cloudescape/govsphere`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/cloudescape/govsphere/`
* Add a git remote pointing to your own fork: `git remote add downstream git@github.com:<your_account>/govsphere.git`
...
## Resources
* **VMware VI object model:** http://www.doublecloud.org/2010/02/object-model-of-vmware-vsphere-api-a-big-picture-in-2-minutes/
